...
public class VideoActivity4 extends YouTubeBaseActivity implements YouTubePlayer.OnInitializedListener {
    Button home;
    Button quiz;
    public static final String API_KEY = "AIzaSyBNhmf7pJjuUao2P_yg4Rug1PKdOTtLRic";
    public static final String VIDEO_ID = "mcF28h9WiGQ&t";
